 ...
 *       &lt;sequence>
 *         &lt;element name="impactingDecision" type="{http://www.w3.org/2001/XMLSchema}QName" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    extends BusinessContextElement
{
    ...
    protected List<QName> impactingDecision;
     ...
     * 
     */
    public List<QName> getImpactingDecision() {
        if (impactingDecision == null) {
            impactingDecision = new ArrayList<QName>();
        }
