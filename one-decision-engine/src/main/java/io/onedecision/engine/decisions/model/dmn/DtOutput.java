    ...
    extends Clause
{
    ...
    protected List<LiteralExpression> outputValue;
     ...
     * This is why there is not a <CODE>set</CODE> method for the outputValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOutputValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LiteralExpression> getOutputValue() {
        if (outputValue == null) {
            outputValue = new ArrayList<LiteralExpression>();
        }
    ...
    public DtOutput withOutputValue(LiteralExpression... values) {
        if (values!= null) {
            for (LiteralExpression value: values) {
                getOutputValue().add(value);
            }
        }
        return this;
    }

    public DtOutput withOutputValue(Collection<LiteralExpression> values) {
        if (values!= null) {
            getOutputValue().addAll(values);
        }
        return this;
    }
