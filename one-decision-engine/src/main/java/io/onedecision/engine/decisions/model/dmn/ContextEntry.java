...
public class ContextEntry implements Serializable {
    ...
    public ContextEntry withVariable(String varName) { 
        withVariable(objFact.createInformationItem().withName(varName));
        return this;
    }
    
    public ContextEntry withVariable(InformationItem value) {
        setVariable(value);
        return this;
    }
    ...
    public ContextEntry withLiteralExpression(String le) { 
        withLiteralExpression(objFact.createLiteralExpression().withText(le));
        return this;
    }
